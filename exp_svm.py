...
SOLVER_METHOD = "minimax"

# FOP method controls.
FOP_OUTER_PENALTY_BASE_RHO = 5.0
FOP_LOWER_WARM_START_MAX_ITERS = 5000
FOP_SUBPROBLEM_NCWC_MAX_OUTER_ITERS = 1000

# FOP stopping controls.
FOP_OUTER_STOP_EPS = 0.5
FOP_OUTER_MAX_ITERS = 1000

# SMO method controls.
SMO_OUTER_INITIAL_EPS = 1 # EPS_0
SMO_OUTER_EPS_DECAY_TAU = 0.5
SMO_LOWER_WARM_START_MAX_ITERS = 5000
SMO_SUBPROBLEM_NCWC_MAX_OUTER_ITERS = 1500

# SMO stopping controls.
SMO_OUTER_STOP_EPS = 0.5

# Deterministic minimax method controls.
MINIMAX_DUAL_LAGRANGE_BOUND = 20.0
# 300 for heart, 3000 for german, 1000 for breast and australian, 750 forionosphere
MINIMAX_NCWC_LIP_H_OVERRIDE = 750.0
MINIMAX_LOWER_WARM_START_ENABLED = True
MINIMAX_LOWER_WARM_START_MAX_ITERS = 5000

# Deterministic minimax stopping controls.
MINIMAX_NCWC_STOP_EPS = 0.5
MINIMAX_NCWC_MAX_OUTER_ITERS = 5000
